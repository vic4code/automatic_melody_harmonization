...
class CVAE(nn.Module):
    def __init__(self, input_dim = 96, 
        ...
        # Latent to decoder
        self.latent2hidden = nn.Linear(latent_size + Constants.BEAT_RESOLUTION * 2 * 12 + 1, self.hidden_size * 2)
...
#         eps = torch.randn(std.shape)
    ...
    def forward(self, input_x, melody, length, cc):
